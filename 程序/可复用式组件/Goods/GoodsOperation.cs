...
namespace Goods
{
    ...
    public class GoodsOperation
    {
        ...
        /// <returns></returns>
        public static bool InsertGoods(string name,string model,string pncode,string state,string remark)
        {
            SqlParameter[] param =
            {
        ...
        /// </summary>
        /// <returns></returns>
        public static DataSet SelectGoodsToDataSet()
        {
        ...
        /// </summary>
        /// <returns></returns>
        public static DataTable SelectGoodsToDataTable()
        {
        ...
        /// <returns></returns>
        public static bool UpdateGoodsOfNameById(string fieldvalue, string conditionvalue)
        {
        ...
        /// <param name="conditionvalue">货物编号</param>
        /// <returns></returns>
        public static bool UpdateGoodsOfModelById(string fieldvalue, string conditionvalue)
        {
        ...
        /// <param name="conditionvalue">货物编号</param>
        /// <returns></returns>
        public static bool UpdateGoodsOfPNCodeById(string fieldvalue, string conditionvalue)
        {
        ...
        /// <param name="conditionvalue">货物编号</param>
        /// <returns></returns>
        public static bool UpdateGoodsOfStateById(string fieldvalue, string conditionvalue)
        {
        ...
        /// <param name="conditionvalue">货物编号</param>
        /// <returns></returns>
        public static bool UpdateGoodsOfRemarkById(string fieldvalue, string conditionvalue)
        {
