...
namespace SQLHelper
{
    ...
    public class SQLOperation
    {
        ...
        public static DataTable QueryDataTable(string database,string sql,CommandType cmdType,SqlParameter[] parms)
        {
            if (string.IsNullOrEmpty(database)) throw new Exception("未设置参数：database");
            if (string.IsNullOrEmpty(sql)) throw new Exception("未设置参数：sql");
        ...
        /// <param name="parms">参数</param>
        /// <returns></returns>
        public static DataSet QueryDataSet(string database,string sql,CommandType cmdType,SqlParameter[] parms)
        {
            if (string.IsNullOrEmpty(database)) throw new Exception("未设置参数：database");
            if (string.IsNullOrEmpty(sql)) throw new Exception("未设置参数：sql");
        ...
        /// <param name="parms">参数</param>
        /// <returns></returns>
        public static object QueryScalar(string database,string sql,CommandType cmdType,SqlParameter[] parms)
        {
            if (string.IsNullOrEmpty(database)) throw new Exception("未设置参数：database");
            if (string.IsNullOrEmpty(sql)) throw new Exception("未设置参数：sql");
        ...
        public static int Execute(string database, string sql, CommandType cmdType, SqlParameter[] parms)
        {
            if (string.IsNullOrEmpty(database))throw new Exception("未设置参数：database");
            if (string.IsNullOrEmpty(sql))throw new Exception("未设置参数：sql");
        ...
        public static DataTable QueryDataTable(string database, string sql, CommandType cmdType, IDictionary<string, object> values)
        {
            ...
            return QueryDataTable(database, sql, cmdType, parms);
        }
        ...
        {
            SqlParameter[] parms = DicToParams(values);
            return QueryDataSet(database, sql, cmdType, parms);
        }
        ...
        {
            SqlParameter[] parms = DicToParams(values);
            return QueryScalar(database, sql, cmdType, parms);
        }
        ...
        {
            SqlParameter[] parms = DicToParams(values);
            return Execute(database, sql, cmdType, parms);
        }
